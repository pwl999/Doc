...
![image](../images/ftrace_kprobe_event/kprobe_event_stub.png)
...
![image](../images/ftrace_kprobe_event/entry_kprobe_event.png)

kretprobe event的数据格式为：

![image](../images/ftrace_kprobe_event/entry_kretprobe_event.png)
