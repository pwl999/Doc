...
![image](../images/ftrace_syscall_event/syscall_event_flow.png)
...
![image](../images/ftrace_syscall_event/entry_syscall_enter_event.png)


syscall exit event的数据格式：

![image](../images/ftrace_syscall_event/entry_syscall_exit_event.png)
